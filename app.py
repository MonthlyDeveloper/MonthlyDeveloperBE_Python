...
from controller import recruitment_board_controller, login_controller, token_controller, test_controller
...
def create_env():
    ...
    api.add_namespace(token_controller.token_ns, '/token')
